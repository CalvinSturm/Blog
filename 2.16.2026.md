...
*CRT phosphors emit brief pulses of light that decay naturally over ~1–3 ms, providing temporal smoothing, while modern LCD pixels are held at a constant brightness for the duration of each frame (~16.7 ms at 60 Hz), which increases retinal persistence and motion blur.*
